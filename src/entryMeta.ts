...
export const weatherOptions: { name: string; icon: LucideIcon }[] = [
  { name: '晴天', icon: Sun }, { name: '多云', icon: CloudSun }, { name: '小雨', icon: CloudRain }, { name: '阴天', icon: Cloud }, { name: '下雪', icon: Snowflake },
];
...
const moodGlyphs: Record<string, string> = { 平静: '◡', 开心: '☀', 感恩: '♡', 低落: '☂', 疲惫: '☾' };
