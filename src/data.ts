...
export const seeds:Entry[]=[
 ...
 {id:'sample-3',title:'原来快乐可以这么小',body:'路过花店，买了一小束洋甘菊。回家的路上一直抱着它，连脚步都变轻了。\n\n把花插进空玻璃瓶，放在窗边。房间没有变大，生活却好像宽阔了一点。',date:daysAgo(3),mood:'开心',weather:'晴天',tags:['小确幸','生活'],favorite:true,updated_at:new Date().toISOString()},
 {id:'sample-4',title:'散步，是和自己重新见面',body:'傍晚沿河走了很远。没有听歌，也没有看手机，只是慢慢地走。\n\n看见一只白鹭站在水边，看见晚风把芦苇吹成一片温柔的海。心里那些没想明白的事，似乎也不急着有答案了。',date:daysAgo(5),mood:'感恩',weather:'多云',tags:['散步','随想'],favorite:false,updated_at:new Date().toISOString()},
 {id:'sample-5',title:'九月，愿我们从容一些',body:'换了一本新笔记本。在第一页写下：允许自己慢慢来。\n\n不必把每一天都过成答案。种一株植物，认真吃饭，记住路过的云。',date:daysAgo(7),mood:'平静',weather:'多云',tags:['日常'],favorite:false,updated_at:new Date().toISOString()}
];
export const entryValid=(e:unknown):e is Entry=>{if(!e||typeof e!=='object')return false;const v=e as Entry;return typeof v.id==='string'&&typeof v.title==='string'&&typeof v.body==='string'&&/^\d{4}-\d{2}-\d{2}$/.test(v.date)&&typeof v.mood==='string'&&typeof v.weather==='string'&&Array.isArray(v.tags)&&v.tags.every(t=>typeof t==='string')&&typeof v.favorite==='boolean'&&typeof v.updated_at==='string'};
