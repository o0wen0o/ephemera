...
export function DraftsPage({ drafts, entries, query, list, setList, setEditing, setDiscardDraft }: {
 drafts: Entry[]; entries: Entry[]; query: string; list: boolean;
 setList: (list: boolean) => void;
 setEditing: (entry: Entry | "new") => void;
 setDiscardDraft: (id: string) => void;
}) { return (<section className="diary-section draft-page">
